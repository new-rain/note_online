<template>
  <div class="friendHome">
    ...
    <el-row>
      ...
      <el-col :span="20">
        <div class="msg ta_l" :style="background">
          <div class="blank_80"></div>
          <el-row>
            <el-col :span="4">
              <el-avatar class="headImg mgl_50" :size="150" :src="friend.headUrl"></el-avatar>
            </el-col>
            <el-col :span="16">
          ...
          <el-tabs type="border-card" stretch>
            ...
            <el-tab-pane label="关注">
              ...
              <div v-for="fri in attentions">
                <el-row>
                  <el-col :span="3">
                    <el-avatar class="mgl_50" :size="100" :src="fri.headUrl" @click="seeUser(fri.no)"></el-avatar>
                  </el-col>
                  <el-col :span="1">
                    <div class="hg_20"></div>
                  </el-col>
            ...
            <el-tab-pane label="收藏">
              <el-tabs :tab-position="tabWhere">
                ...
                <el-tab-pane label="笔记本">
                  <div v-for="collectionNotebook in colNotebooks" class="ta_l" @click="seeNotebook(collectionNotebook.bno)">
                    <el-row>
                      <el-col :span="4">
