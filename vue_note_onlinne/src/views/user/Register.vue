    ...
    <el-row>
      ...
      <el-col :span="10" class="right">
        ...
        <div class="reg">
          ...
          <el-input class="mgt_20" type="password" v-model="password" placeholder="请输入6-18位密码，可以包含字母、数字"></el-input>
      ...
      <el-row class="img">
        ...
        <el-col :span="20">
          <div class="cov">
            ...
            <el-radio v-model="cover" label="http://localhost:8888/img/user_head/default_head_img.jpg">默认
            </el-radio>
          </div>
          <div class="cov">
        ...
        if (email !== "") {
          this.$axios.get("getcode?email=" + email).then(res => {
            if (res.data) {
              this.$message({
                showClose: true,
                message: '验证码已发送至您的邮箱，请查收，验证码十分钟内有效',
                type: 'success'
              });
            } else {
              this.$message({
